...
hostnumber = input("Enter Host DIGIT value: ") 

data = network.list_vlans(name=project + "_vlan_connect_*")
#print(data)
#print(data[0])
#print(data[0]['id'])
#print(data[0]['name'])
...
for i in data:
  ...
  data2 = hardware.list_hardware(hostname=project + "-vmware-host-" + hostnumber + "*")
